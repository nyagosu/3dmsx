...
/* Create Object */
EMU2413_API OPLL *OPLL_new(OPLL *opll, e_uint32 clk, e_uint32 rate) ;
#if 0
...
EMU2413_API int OPLL_serialize(OPLL * o, char * buf );
EMU2413_API void OPLL_deserialize(OPLL * o, char * buf );
